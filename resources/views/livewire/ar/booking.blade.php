    ...
    <section id="appointment" class="st-shape-wrap st-gray-bg">
        ...
        <div class="container">
            <div class="st-section-heading st-style1">
                <h2 class="st-section-heading-title">{{'احجز موعد '}}</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <form wire:submit.prevent="Save()" class=" st-appointment-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="st-form-field st-style1">
                                    ...
                                    <input type="text" wire:model="name" placeholder="الاسم كامل" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="st-form-field st-style1">
                                    ...
                                    <div class="st-custom-select-wrap">
                                        <select class="form-control" data-placeholder="اختر القسم "
                            ...
                            <div class="col-lg-4">
                                <div class="st-form-field st-style1">
                                    <label>{{'الدكتور'}}</label>
                                    <div class="st-custom-select-wrap">
                                        <select class="form-control" data-placeholder="اختر الدكتور "
                            ...
                            <div class="col-lg-4">
                                <div class="st-form-field st-style1">
                                    <label>{{'الفرع'}} </label>
                                    <div class="st-custom-select-wrap">
                                        <select class="form-control" data-placeholder="اختر الفرع"
                            ...
                            <div class="col-lg-12">
                                <button class="st-btn st-style1 st-color1 st-size-medium" type="submit">{{'تأكيد
                                    الحجز'}}</button>
                            </div>
                        </div>
                    </form>
