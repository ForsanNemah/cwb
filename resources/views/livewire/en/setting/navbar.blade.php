                ...
                <div class="st-top-header-in">
                    <ul class="st-top-header-list">
                        <li>
                            ...
                            <a href="{{$websiteSettingEn->email ?? ''}}">{{$websiteSettingEn->email ?? ''}}</a>
                        </li>
                        <li>
                            ...
                            <a href="{{$websiteSettingEn->phone1 ?? ''}}">{{$websiteSettingEn->phone1 ?? ''}}</a>
                        </li>
                    </ul>
                    ...
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#home"
                                        class="st-smooth-move">Home</a></li>
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#about"
                                        class="st-smooth-move">About</a></li>
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#department"
                                        class="st-smooth-move">Department</a></li>
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#doctors"
                                        class="st-smooth-move">Doctors</a></li>
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#gallery"
                                ...
                                <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}#contact"
                                        class="st-smooth-move">Contact</a></li>
                                <li class="menu-item-has-children"><a class="st-smooth-move">{{'Language'}}</a>
                                    <ul>
                                        <li><a href="{{url('/index/'.$websiteSettingEn->team_id)}}">{{'العربية'}}</a>
                                        </li>
                                        <li><a href="{{url('/indexen/'.$websiteSettingEn->team_id)}}">{{'English'}}</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
