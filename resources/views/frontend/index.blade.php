...
<div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg"
        ...
        <div class="container">
            <div class="st-hero-text">
                ...
                <div class="st-hero-btn">
                    <a href="#appointment" class="st-btn st-style1 st-color1 st-smooth-move">{{'احجز الآن'}}</a>
                </div>
            </div>
        </div>
        <div class="st-hero-social-group">
            <div class="container">
                <ul class="st-social-btn st-style1 st-mp0">
                    <li><a href="{{$appSettingAr->facebook ?? ''}}"><i class="fab fa-facebook-square"></i></a></li>
                    <li><a href="{{$appSettingAr->instagram ?? ''}}"><i class="fab fa-linkedin"></i></a></li>
                    <li><a href="{{$appSettingAr->pinterest ?? ''}}"><i class="fab fa-pinterest-square"></i></a></li>
                    <li><a href="{{$appSettingAr->twitter ?? ''}}"><i class="fab fa-twitter-square"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="slick-wrapper">
                ...
                <div class="slick-slide-in">
                    <div class="st-hero-img">
                        <img src="{{asset('storage/'.$header->image)}}" alt="Hero img">
                    </div>
                </div>
                @empty
    ...
    <div class="st-hero-shape"><img src="{{asset('assets/img/shape/hero-shapertl.png')}}" alt="hero shape"></div>
</div>
<!-- End Hero Seciton -->
            ...
            <div class="col-lg-4">
                <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box">
                        <img src=" {{asset('storage/'.$home->image1)}}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{$home->title1}}</h2>
            ...
            <div class="col-lg-4">
                <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-green-box">
                        ...
                        <img src=" {{asset('storage/'.$home->image2)}}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{!!$home->title2!!}</h2>
                    <div class="st-iconbox-text">
                        {!!$home->paragraph2!!}
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-red-box">
                        <img src=" {{asset('storage/'.$home->image3)}}" alt="">
                    </div>
                    <h2 class=" st-iconbox-title">{!!$home->title3!!}</h2>
                    <div class="st-iconbox-text">
                        {!!$home->paragraph1!!}
                    </div>
                </div>
...
<section class="st-about-wrap" id="about">
    ...
    <div class="container">
        <div class="st-section-heading st-style1">
            <h2 class="st-section-heading-title">{!!$about->title1!!}</h2>
            <div class="st-seperator">
                <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                <div class="st-seperator-center">

                    <img src=" {{asset('storage/'.$appSettingAr->icon)}}" alt="icon">
                    {{--
                    ...
                    <div class="st-vertical-middle-in">
                        <div class="st-text-block st-style1">
                            ...
                            <div class="st-text-block-avatar">
                                <div class="st-avatar-img"><img src=" {{asset('storage/'.$about->director_image)}}"
                                        alt="avatar">
                                </div>
                                <div class="st-avatar-info">
                                    <h4 class="st-avatar-name">{!!$about->director_name!!}</h4>
                                    <div class="st-avatar-designation">{!!$about->director_info!!}</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-shedule-wrap">
                    <div class="st-shedule">
                        <h2 class="st-shedule-title">{{'الجدول الزمني الاسبوعي '}}</h2>
                        <ul class="st-shedule-list">

                            @forelse ($WeeklyTimetables as $WeeklyTimetable)
                            <li>
                                <div class="st-shedule-left">{!! $WeeklyTimetable->day!!}</div>
                                <div class="st-shedule-right">{!! $WeeklyTimetable->for_hour!!} – {!!
                                    $WeeklyTimetable->to_hour!!} </div>
                            </li>
                            @empty
                        ...
                        <div class="st-call st-style1">
                          ...
                          c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z" />
                            ...
                            <div class="st-call-text">
                                <div class="st-call-title">{{'اتصل الآن'}}</div>
                                <div class="st-call-number">{!!$appSettingAr->phone1 ?? ''!!}</div>

                                <div class="st-call-number">{!!$appSettingAr->phone2 ?? ''!!}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<livewire:ar.departments :team_id="$team_id" :description='$description' />

{{--نهاية عرض الاقسام --}}


{{-- بداية الحجز--}}
<livewire:ar.booking :team_id="$team_id" :description='$description' />
{{-- نهاية الحجز--}}


{{-- بداية الدكاتره--}}
<livewire:ar.view-doctor :team_id="$team_id" :description='$description' />
{{-- نهاية الدكاترة --}}

{{-- بداية عرض الصور--}}
<livewire:ar.view-gallery :team_id="$team_id" :description='$description' />
{{-- نهاية عرض الصور--}}



{{-- بداية عرض الحالات قبل وبعد--}}
@if ($procedure!= NULL)
<section class="st-before-after-section st-dynamic-bg st-bg" data-src="{{asset('assets/img/before-after-bg.jpg')}}">
    <div class="st-height-b120 st-height-lg-b80"></div>
    <div class="container">
        <div class="st-section-heading st-style1">
            <h2 class="st-section-heading-title">{!! $procedure->title!!}</h2>
            <div class="st-seperator">
                <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                <div class="st-seperator-center">
                    {{--
            ...
            <div class="st-before-after-in">
                <div class="st-before-after">
                    <div class="st-after st-single-slide st-dynamic-bg"
                        data-src=" {{asset('storage/'.$procedure->after)}}">
                    </div>
                    <div class="st-before st-single-slide st-dynamic-bg"
                        data-src=" {{asset('storage/'.$procedure->before)}}"></div>
...
@endif
{{-- نهاية عرض الحالات قبل وبعد--}}


{{--بداية عرض اراء الناس--}}
<!-- Start Testimonial Seciton -->
<section>
    <div class="st-height-b120 st-height-lg-b80"></div>
    <div class="container">
        <div class="st-section-heading st-style1">
            <h2 class="st-section-heading-title"> {{'ماذا يقول الناس '}}</h2>
            <div class="st-seperator">
                <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                <div class="st-seperator-center">
                    {{--
        ...
        <div class="st-slider st-style2 st-pricing-wrap">
            <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div class="slick-wrapper">
                    ...
                    @forelse ($sayingPeoples as $sayingPeople)

                    <div class="slick-slide-in">
                        <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                            data-wow-delay="0.2s">
                            <div class="st-testimonial-info">
                                <div class="st-testimonial-img"><img src=" {{asset('storage/'.$sayingPeople->image)}}"
                                        alt="avatar1"></div>
                                <div class="st-testimonial-meta">
                                    <h4 class="st-testimonial-name">{!! $sayingPeople->name !!}</h4>
                                    <div class="st-testimonial-designation">{!! $sayingPeople->job !!}</div>
                                </div>
                            </div>
                            <div class="st-testimonial-text">
                                {!! $sayingPeople->content !!}
                            </div>
...
{{-- نهاية عرض اراء الناس--}}


{{--بداية عرض احصائيات عن العيادة--}}
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="st-funfact st-style1">
                            ...
                            <h2 class="st-funfact-number st-counter">{!! $about->year_of_experience !!}</h2>
                            <div class="st-funfact-title">
                                {{'سنوات من الخبرة'}}
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        c6.758,3.902,14.26,5.896,21.861,5.896c3.811,0,7.646-0.5,11.425-1.514C408.75,390.222,422.663,366.121,416.404,342.76z" />
                            ...
                            <h2 class="st-funfact-number st-counter">{!! $about->happy_patients !!}</h2>
                            <div class="st-funfact-title">{{'المرضى سعداء'}}</div>
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                    </div><!-- .col -->
                    <div class="col-lg-6">
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z" />
                            ...
                            <h2 class="st-funfact-number st-counter">{!! $about->qualified_doctor !!}</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="st-funfact st-style1">
                            ...
                            <h2 class="st-funfact-number st-counter">{!! $about->hospital_rooms !!}</h2>
                            <div class="st-funfact-title">{{'غرف المستشفى'}}</div>
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                    </div><!-- .col -->
                </div>
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-video-block st-style1 st-zoom">
                    <div class="st-video-block-img st-zoom-in st-dynamic-bg"
                        data-src=" {{asset('storage/'.$about->video_bg)}}">
                    </div>
                    <a href="{!!$about->video!!}" class="st-play-btn st-style1 st-video-open">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            x="0px" y="0px" viewBox="0 0 336 336" xml:space="preserve">
                            <g>
                                <path
                      ...
                      C244,167.6,244,168,244,168.4z" />
                        ...
                        <span class="st-video-animaiton"><span>
                            </span></span>
                    </a>
                </div>
            </div><!-- .col -->
...
<section class="st-faq-wrap st-shape-wrap">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h2 class="st-accordian-heading">فقط أجب على الأسئلة </h2>
                <div class="st-accordian-wrap">

                    @forelse ($questions as $key =>$questionItem)
                    <div class="st-accordian {{$key ==0 ? 'active' : ''}} ">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="st-post st-style3">
                    <a href="{{url('/blog/'.$blog->id.'/team_id/'.$team_id)}}"
                        class="st-post-thumb st-link-hover-wrap st-zoom">
                        <img class="st-zoom-in" src=" {{asset('storage/'.$blog->blogCategory->image)}}" alt="blog1">
                        <span class="st-link-hover"><i class="fas fa-link"></i></span>
                    </a>
                    <div class="st-post-info">
                        <h2 class="st-post-title"><a href="{{url('/blog/'.$blog->id.'/team_id/'.$team_id)}}">
                                {{$blog->blogCategory->name}}

                            </a></h2>

                        {{-- <div class="st-post-meta">
                            <span class="st-post-date">{{$BlogCategory->date}}</span>
                            <span>
                                <a href="#" class="st-post-avatar">
                                    <span class="st-post-avatar-text"> {{$blog->blogCategory->name}}</span>
                                </a>
                            </span>
                        </div> --}}
                    ...
                    <div class="st-post-footer">
                        ...
                        <a class="st-btn st-style2 st-color1 st-size-medium"
                            href="{{url('/blog/'.$blog->id.'/team_id/'.$team_id)}}">
                            قراءة المزيد
                        ...
                        {{-- <a href="{{url('/blog-details/'.$blog->blogCategory->id.'/team_id/'.$team_id)}}"
...
{{-- بداية عرض الشعارات--}} <div class="st-gray-bg">
    <div class="st-height-b120 st-height-lg-b80"></div>
    <div class="container">
        <div class="st-slider st-style2 st-pricing-wrap">
            <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div class="slick-wrapper">
                    ...
                    @forelse ($LogoCarousels as $LogoCarousel)
                    <div class="slick-slide-in">
                        <div class="st-logo-carousel st-style1 st-orange-box">
                            <img src=" {{asset('storage/'.$LogoCarousel->logo)}}" alt="client1">
                        </div>
                    </div><!-- .slick-slide-in -->
                    @empty
                    @endforelse
...
{{-- بداية تواصل معنا--}}
<livewire:ar.contact :team_id="$team_id" :description='$description' />
{{-- نهاية تواصل معنا--}}

<div class=" st-google-map">
    <iframe src=" {{$appSettingAr->google_map}}" all owfullscreen></iframe>
</div>
