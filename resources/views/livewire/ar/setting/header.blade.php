                    ...
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                ...
                                <li><a href="#about" class="st-smooth-move">{{'عن الموقع'}}</a></li>
                                <li><a href="#department" class="st-smooth-move">{{'الأقسام'}}</a></li>
                                <li><a href="#doctors" class="st-smooth-move">{{'الأطباء '}}</a></li>
                                <li><a href="#gallery" class="st-smooth-move">{{'الصور'}}</a></li>
                                <li><a href="#blog" class="st-smooth-move">{{'المدونة'}}</a></li>
