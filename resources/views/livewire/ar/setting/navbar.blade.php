                ...
                <div class="st-top-header-in">
                    <ul class="st-top-header-list">
                        <li>
                            ...
                            <a href="#">{{$websiteSettingAr->email ?? ''}}</a>
                        </li>
                        <li>
                            ...
                            <a href="#">{!!$websiteSettingAr->phone1 ?? ''!!}</a>
                        </li>
                    </ul>
                    <a href="#appointment" class="st-top-header-btn st-smooth-move">{{'احجز موعد'}}</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#home')}}"
                                        class="st-smooth-move">{{'الرئيسية'}}</a></li>
                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#about')}}"
                                        class=" st-smooth-move">{{'عن الموقع'}}</a></li>

                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#department')}}"
                                        class="st-smooth-move">{{'الأقسام'}}</a></li>
                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#doctors')}}"
                                        class="st-smooth-move">{{'الأطباء '}}</a></li>


                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#gallery')}}"
                                        class="st-smooth-move">{{'الصور'}}</a></li>
                                <li class="menu-item-has-children"><a
                                        href="{{url('/index/'.$websiteSettingAr->team_id.'#blog')}}"
                                        class="st-smooth-move">{{'المدونة'}}</a>
                                    <ul>
                                ...
                                <li><a href="{{url('/index/'.$websiteSettingAr->team_id.'#contact')}}"
                                        class="st-smooth-move">{{'تواصل معنا '}}</a></li>

                                <li class="menu-item-has-children"><a class="st-smooth-move">{{'اللغة'}}</a>
                                    <ul>
                                        <li><a href="{{url('/index/'.$websiteSettingAr->team_id)}}">{{'العربية'}}</a>
                                        </li>
                                        <li><a href="{{url('/indexen/'.$websiteSettingAr->team_id)}}">{{'English'}}</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
