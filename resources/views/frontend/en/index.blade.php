...
{{-- @include('layouts.inc.en.header') --}}

<livewire:en.setting.header :team_id="$team_id" />
...
<div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg"
        ...
        <div class="container">
            <div class="st-hero-text">
                ...
                <h1 class="st-hero-title cd-headline slide">
                    ...
                    treatment for <span class="cd-words-wrapper">
        ...
        <div class="st-hero-social-group">
            <div class="container">
                <ul class="st-social-btn st-style1 st-mp0">
                    <li><a href="{{$appSettingEn->facebook ?? ''}}"><i class="fab fa-facebook-square"></i></a></li>
                    <li><a href="{{$appSettingEn->instagram ?? ''}}"><i class="fab fa-linkedin"></i></a></li>
                    <li><a href="{{$appSettingEn->pinterest ?? ''}}"><i class="fab fa-pinterest-square"></i></a></li>
                    <li><a href="{{$appSettingEn->twitter ?? ''}}"><i class="fab fa-twitter-square"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="st-hero-shape"><img src="{{asset('assets/img/shape/hero-shape.png')}}" alt="hero shape"></div>
</div>
<!-- End Hero Seciton -->
                    ...
                    <div class="st-vertical-middle-in">
                        <div class="st-text-block st-style1">
                            ...
                            <div class="st-text-block-avatar">
                                <div class="st-avatar-img"><img src="{{asset('assets/img/avatar1.png')}}" alt="avatar">
                                </div>
                    ...
                    <div class="st-shedule">
                      ...
                      c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z" />
                            ...
                            <div class="st-call-text">
                                ...
                                <div class="st-call-number">{!!$appSettingEn->phone1 ?? ''!!}</div>
                                <div class="st-call-number">{!!$appSettingEn->phone2 ?? ''!!}</div>
                            </div>
                        </div>
                    </div>
...
{{-- بداية عرض الاقسام--}}
<livewire:en.departments :team_id="$team_id" :description='$description' />
{{--نهاية عرض الاقسام --}}
...
{{-- بداية الدكاتره--}}
<livewire:en.view-doctor :team_id="$team_id" :description='$description' />
{{-- نهاية الدكاترة --}}

{{-- بداية عرض الصور--}}
<livewire:en.view-gallery :team_id="$team_id" :description='$description' />
{{-- نهاية عرض الصور--}}


{{-- بداية عرض الحالات قبل وبعد الاجراءات--}}
<!-- Start Before After -->
@if ($procedure!= NULL)
...
@endif
{{-- نهاية عرض الحالات قبل وبعد الاجراءات--}}
...
{{--نهاية عرض احصائيات عن العيادة--}}


{{-- بداية عرض الاسئلة الشائعة--}}
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="st-post st-style3">
                    <a href="{{url('/blog-en/'.$blog->id.'/team_id/'.$team_id)}}"
                    ...
                    <div class="st-post-info">
                        <h2 class="st-post-title"><a href="{{url('/blog-en/'.$blog->id.'/team_id/'.$team_id)}}">
                        ...
                        {{-- <div class="st-post-meta">
                            ...
                            <span>
                                {{'منشور بواسطة: '}}<a href="#" class="st-post-avatar">
...
{{-- بداية تواصل معنا--}}
<livewire:en.contact :team_id="$team_id" :description='$description' />
{{-- نهاية تواصل معنا--}}


<div class="st-google-map">
    <iframe src="{{$appSettingEn->google_map}}" all owfullscreen></iframe>
</div>
